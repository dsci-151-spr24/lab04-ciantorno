...
***There are `r nrow(laquinta)` rows and `r ncol(laquinta)` columns.  Each row represents the data for one La Quinta hotel.  The variables are: `r names(laquinta)`.***
...
***Most La Quintas are located in the US, but there are also locations in other parts of the world.  Denny's are only located in the US.***
...
***We can US the State variable to determine whether or not an establishment is located in the US and compare the state listed to a database of states in the US***
...
***These La Quinta locations are in Mexico, Colombia, Honduras, and Canada.***
...
(The above r code still is not working for me, so I did not change the eval to true.)
...
***California has the most Denny's locations, with 403 in all, while Delaware has the lowest, with 1 location.  Texas has the most La Quinta hotels, at 237, while Maine has the least, at 1.***
...
***Visually, it looks like Hedberg's joke does not hold up that well, since not many La Quintas and Denny's are next to each other in North Carolina.***
...
***The joke holds up a lot better visually here, since many dots representing Denny's are close to dots that represent La Quinta.***
